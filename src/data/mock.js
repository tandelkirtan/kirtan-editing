...
export const profile = {
  ...
  whatsapp: "9664546853",
  whatsappFull: "+919664546853",
  email: "kirtandel.ai@gmail.com",
...
export const socials = [
  { label: "Dimeera Photography", handle: "@dimeeraphotography", url: "https://www.instagram.com/dimeeraphotography" },
  { label: "Varni Exim Institute", handle: "@varni_exim_institute", url: "https://www.instagram.com/varni_exim_institute" },
  { label: "Artist Editing", handle: "@artist_editing", url: "https://www.instagram.com/artist_editing" },
  { label: "Pro Muscle Fitness", handle: "@pro.musclefitness", url: "https://www.instagram.com/pro.musclefitness?igsh=MThscWRpN2VtOTZ6NA==" },
  { label: "Letsfit Official", handle: "@letsfit.official", url: "https://www.instagram.com/letsfit.official?igsh=c2F2amZ5Y3Jhbjd4" },
  { label: "Global Tea Cafe", handle: "@globalteacafevapigujrat", url: "https://www.instagram.com/globalteacafevapigujrat?igsh=MWFxYjlwYmQ1OHJtdg==" },
  { label: "AMT Luxury", handle: "@amt.luxury", url: "https://www.instagram.com/amt.luxury?igsh=bWozejUzNTJwMXAz" },
  { label: "Boketto Travels", handle: "@bokettotravels", url: "https://www.instagram.com/bokettotravels?igsh=MXRjeWM1Yzl3emFnbg==" },
];

export const services = [
  {
    title: "Wedding Films",
    desc: "Cinematic wedding edits, highlight reels and traditional ceremony films \u2014 colour graded, music synced, story driven.",
    tag: "Cinematic",
  },
  {
    title: "Commercial Content",
    desc: "Brand reels, product launches and ad films designed to convert. Punchy cuts, bold typography, modern motion design.",
    tag: "Brands",
  },
  {
    title: "Government Projects",
    desc: "Awareness campaigns, event coverage and official documentaries handled with full confidentiality and on-time delivery.",
    tag: "Public",
  },
  {
  ...
  },
  {
    ...
    desc: "End-to-end content creation, scheduling and editing for multiple Instagram pages. Reels, posts, stories \u2014 done right.",
    tag: "Social",
  },
  {
...
export const tools = [
  { name: "Adobe Premiere Pro", gradient: "from-[#FF2D95] to-[#FF1493]" },
  { name: "DaVinci Resolve", gradient: "from-[#FF6B1A] to-[#00D4FF]" },
  { name: "After Effects", gradient: "from-[#FF2D95] to-[#7C3AED]" },
  { name: "CapCut Pro", gradient: "from-[#FF6B1A] to-[#10B981]" },
  { name: "Adobe Photoshop", gradient: "from-[#FF2D95] to-[#EC4899]" },
  { name: "Adobe Lightroom", gradient: "from-[#FF6B1A] to-[#F59E0B]" },
  { name: "Canva Pro", gradient: "from-[#FF2D95] to-[#8B5CF6]" },
  { name: "Adobe Illustrator", gradient: "from-[#FF6B1A] to-[#EF4444]" },
  { name: "Final Cut Pro", gradient: "from-[#FF2D95] to-[#06B6D4]" },
  { name: "Filmora", gradient: "from-[#FF6B1A] to-[#84CC16]" },
  { name: "AI Tools", gradient: "from-[#FF2D95] to-[#F97316]" },
  { name: "Adobe Bridge", gradient: "from-[#FF6B1A] to-[#6366F1]" },
];
...
export const testimonials = [
  {
    name: "Ketan Patel",
    role: "Owner, Dimeera Photography",
    quote: "Kirtan turned 6 hours of raw wedding footage into a 90-second film that made the family cry. He just gets pacing.",
  },
  {
    name: "Jaydeep Vaghani",
    role: "Marketing Lead, Varni Exim Institute",
    quote: "Our reels started actually performing after Kirtan took over the editing. Bold, clean, on-brand \u2014 every single time.",
  },
  {
    name: "Rohan Desai",
    role: "Founder, Artist Editing",
    quote: "Reliable, fast, and ridiculously good with colour. He delivers like a studio, not a freelancer.",
  },
  {
    name: "Amit Kumar",
    role: "Director, Pro Muscle Fitness",
    quote: "The editing quality he brings to our fitness content is next level. Every cut, every transition is perfectly timed.",
  },
  {
    name: "Nisha Patel",
    role: "Manager, Letsfit Official",
    quote: "Kirtan transformed our Instagram presence. Our engagement increased by 300% after he started editing our reels.",
  },
  {
    name: "Rajesh Shah",
    role: "Owner, Global Tea Cafe",
    quote: "Professional, creative, and always delivers on time. He understands our brand vision perfectly.",
  },
  {
    name: "Pooja Mehta",
    role: "Marketing Head, AMT Luxury",
    quote: "The luxury content he creates for us is stunning. He knows how to make products look premium.",
  },
  {
    name: "Karan Singh",
    role: "Founder, Boketto Travels",
    quote: "Our travel content has never looked better. Kirtan has a unique eye for storytelling through editing.",
  },
  {
    name: "Sneha Reddy",
    role: "Wedding Client",
    quote: "He captured emotions we didn't even know existed in our wedding footage. Absolutely magical work.",
  },
];
