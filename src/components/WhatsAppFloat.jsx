...
export default function WhatsAppFloat() {
  ...
  return (
    ...
    >
      ...
      <span className="relative flex items-center justify-center w-10 h-10 rounded-full bg-[#25D366] text-white shadow-[0_10px_30px_rgba(37,211,102,0.4)] hover:shadow-[0_14px_40px_rgba(37,211,102,0.6)] transition-shadow">
